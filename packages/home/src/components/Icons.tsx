...
function wrap(Icon: LucideIcon) {
  return (p: IconProps) => <Icon {...p} size={p.size ?? 18} strokeWidth={1.8} />
}

/** GitHub 官方 mark（lucide 不提供品牌图标），fill 绘制 */
export const GitHubIcon = (p: IconProps) => (
  <svg width={p.size ?? 18} height={p.size ?? 18} viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" class={p.class}>
...
export const HardDriveIcon = wrap(HardDrive)
